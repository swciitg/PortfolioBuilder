...
const Option1 = (props) => {
  ...
  return (
    <section className="w-full h-screen" id="awards" style={{ fontFamily: "Poppins" }}>
      <div className="w-full h-full px-4 md:px-32 pt-24 pb-5 mb-10 md:pt-28 bg-orange-600">
        <div className="h-24 md:h-40 text-4xl font-bold md:pl-2 text-black">Get in touch!</div>
        <div className="flex flex-col md:flex-row gap-2 md:gap-4 h-auto pb-2 md:px-24 md:pb-6 w-full items-center justify-center">
          ...
          <div className="flex flex-col h-1/2 md:h-full w-full gap-y-4 px-0 md:px-16 pt-8 md:pt-0 items-center justify-end md:justify-center">
            ...
            <p className="text-start text-sm font-medium capitalize tracking-wide flex items-center" style={{ fontFamily: "Manrope", color: "rgba(57, 57, 57, 1)" }}>
                <span className="material-symbols-outlined text-sm ml-10 md:text-lg mr-1">location_on</span>
                <span>{Address}</span>
            </p>
              <div className="ml-10">+91 {Phone}</div>
              <a className="hover:opacity-80 ml-10" id="mailId" href={`mailto:${Email}`}>
                {Email}
              </a>
            <div className="w-screen bg-orange-600 justify-center items-center">
            <div className="flex h-1/2 md:h-full justify-between md:justify-center bg-orange-600 ml-10">
