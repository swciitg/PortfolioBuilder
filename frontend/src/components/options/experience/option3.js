...
const option1 = (props) => {
  ...
  return (
        ...
        <div className="w-full px-0 md:px-32 pt-12 md:pt-24">
            ...
            <div className="ml-4 md:ml-28 mt-1 md:mt-2 mb-6 text-4xl" style={{ color: 'rgba(57, 57, 57, 1)' }}>{experienceTitle}</div>
            <div className="mt-4 md:mt-2 ml-4 md:ml-28 text-lg tracking-tight" style={{ color: 'rgba(22, 22, 22, 1)' }}>I’m proud to have collaborated with some awesome companies:</div>
            <div className="w-full px-4 md:px-28 mt-12 md:mt-16 mb-4 md:mb-8 flex gap-3 md:gap-6">
