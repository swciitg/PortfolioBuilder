    ...
    <div className='fixed top-0 left-0 z-20 w-full rounded-full flex justify-center font-Manrope'>
      ...
      >
        <a href="#about" className='mx-2 md:mx-4'>
          <span className='inline-block hover:text-blue-400 text-center hover:scale-[1.03]'>
            About
          </span>
        </a>
        ...
        {isSkillEnabled && skills && skills.length > 0 && (
          <a href="#skills" className='hidden md:block hover:text-blue-500 mx-1 md:mx-4'>
            <span className='inline-block hover:text-blue-400 text-center hover:scale-[1.03]'>
              Skills
            </span>
          </a>
        ...
        {isProjectEnabled && projects && projects.length > 0 && (
          <a href="#projects" className='rounded-2xl mx-2 md:mx-4'>
            <span className='inline-block hover:text-blue-400 text-center hover:scale-[1.03]'>
              Projects
            </span>
          </a>
        ...
        <a href="#touch" className='rounded-2xl mx-2 md:mx-4 hover:text-blue-400'>
          <span className='inline-block text-center hover:scale-[1.03] border border-white rounded-md p-1'>
            Get in touch
          </span>
        </a>
      </div>
